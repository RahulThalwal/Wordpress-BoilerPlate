        ...
        <div class="panel-body">
            <form class="form-horizontal" action="javascript:void(0)" id="frm-create-book">
                    ...
                    <div class="col-sm-5">
                       ...
                       if(count($book_shelf) > 0){
                        foreach ($book_shelf as $key => $value){
                            ?>
                            <option value="<?php echo $value->id; ?>"><?php echo strtoupper($value->shelf_name); ?>
                            </option>
                            <?php
                        }
                       }
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="button" type="button" value="Upload image" class="form-control" id="txt_image"
                            name="txt_image">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="number" required class="form-control" min="1" id="txt_cost" name="txt_cost"
